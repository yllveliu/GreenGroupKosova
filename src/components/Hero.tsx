...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-[100svh] flex items-center pt-24 sm:pt-28 overflow-hidden bg-slate-900">
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-2xl lg:max-w-3xl">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary-500/10 border border-primary-500/20 text-primary-400 text-xs sm:text-sm font-medium mb-6 backdrop-blur-sm max-w-full"
          >
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-[1.1] mb-6"
          >
            {t.hero.titleStart}{' '}
          ...
          <motion.p
            ...
            className="text-base sm:text-lg lg:text-xl text-slate-300 mb-10 leading-relaxed max-w-2xl"
          >
            {t.hero.description}
          </motion.p>
          ...
          <motion.div
            ...
            className="mt-12 sm:mt-16 grid grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 border-t border-white/10 pt-6 sm:pt-8"
          >
            ...
            <div className="flex flex-col items-center text-center">
              <span className="text-2xl sm:text-3xl font-bold text-white">200t+</span>
            ...
            <div className="flex flex-col items-center text-center col-span-2 lg:col-span-1">
              <span className="text-2xl sm:text-3xll font-bold text-white">100%</span>
